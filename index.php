...
<body  class="front-page">
   ...
   <!-- /.navbar -->
    ...
    <section class="section section-light">
           <div class="container">
                <div class="seporator"></div>
                <h2 class="section-title section-title-light">схема работы</h2>
                <!-- Основной блок слайдера -->
                ...
                <!-- <ol class="steps">
                    <li class="steps-item">
                        ...
                        <h3 class="steps-title">Знакомство</h3>
                        <p class="steps-text">Безусловно, сплочённость команды профессионалов позволяет оценить значение форм воздействия.</p>
                        <a class="steps__link" href="#">Оставить заявку</a>
                    </li>
                    <li class="steps-item">
                        <span class="steps-num">02</span>
                        <h3 class="steps-title">Заключение<br>договора</h3>
    ...
    <section class="section production">
             <div class="container">
                <div class="seporator"></div>
                <h2 class="section-title section-title-production">Контрактное производство</h2>
                <div class="cards">
                    <a href="#" class="card">
                        ...
                        <img src="img/auto.png" alt="Автомобильная химия" class="card-image">
                    </a>
                    <a href="#" class="card">
                         <div class="card-content">
                        ...
                        <img src="img/chemistry.png" alt="Бытовая химия" class="card-image">
                    </a>
                    <a href="#" class="card">
                          <div class="card-content">
                        ...
                        <img src="img/funds.png" alt="Дезинфицирующие средства" class="card-image">
                    </a>
                    <a href="#" class="card">
                          <div class="card-content">
                        ...
                        <img src="img/funds.png" alt="Пищевые аэрозоли" class="card-image">
                    </a>
                    <a href="#" class="card">
                         <div class="card-content">
                        ...
                        <img src="img/auto.png" alt="Косметическая продукция" class="card-image">
                    </a>
                    <a href="#" class="card">
                         <div class="card-content">
                        ...
                        <img src="img/chemistry.png" alt="Краски аэрозольные" class="card-image">
                    </a>
                </div>
             </div>
    </section>
     <!-- <section class="brand">
           <div class="container">
              <div class="seporator"></div>
              <h2 class="section-title brand-main-title">собственные торговые марки</h2>
              <div class="brand-wrapper">
                   <a href="#" class="brand-block">
                        <svg class="brand-img"  width="180" height="180">
       ...
       <section class="section clients">
                ...
                <div class="clients-wrapper">
                      <div class="clients-content">
                        <h2 class="section-title section-title-clients">Производим аэрозольную продукцию для разных сфер</h2>
                        <ul class="clients-list">
                            <li class="clients-list-item">
                                <svg width="30" height="30" class="clients-list-icon">
                                    <use href="img/icon/sprite.svg#him"></use>
                                </svg>
                                Химические производства
                            </li>
                            <li class="clients-list-item">
                                <svg width="30" height="30" class="clients-list-icon">
                                    <use href="img/icon/sprite.svg#car"></use>
                                </svg>
                                Автомойки
                            </li>
                            <li class="clients-list-item">
                            ...
                            <li class="clients-list-item">
                                <svg width="30" height="30" class="clients-list-icon">
                                    <use href="img/icon/sprite.svg#shirt"></use>
                                </svg>
                                Косметика по уходу за одеждой
                            </li>
                            <li class="clients-list-item">
                                <svg width="30" height="30" class="clients-list-icon">
                                    <use href="img/icon/sprite.svg#boots"></use>
                                </svg>
                                Косметика по уходу за обувью
                            </li>
                            <li class="clients-list-item">
                                <svg width="30" height="30" class="clients-list-icon">
                                    <use href="img/icon/sprite.svg#bricks"></use>
                                </svg>
                                Строительные материалы
                            </li>
                            <li class="clients-list-item">
                                <svg width="30" height="30" class="clients-list-icon">
                                    <use href="img/icon/sprite.svg#more"></use>
                                </svg>
                                И многих других
                            </li>
                        </ul>
                ...
                <div class="clients-logo-list">
                    <a href="#" class="clients-logo-item">
                        <img src="img/client.png" alt="burger" class="clients-logo">
                    </a>
                    <a href="#" class="clients-logo-item">
                        <img src="img/client.png" alt="burger" class="clients-logo">
                    </a>
       ...
       <section class="section blog">
                <div class="container">
                     <div class="seporator"></div>
                     <h2 class="section-title section-title-blog">Блог экспертов в области производства</h2>
                    ...
                    <div class="swiper blog-slider">
                        ...
                        <div class="swiper-wrapper">
                            ...
                            <a href="#" class="swiper-slide blog-card">
                                  <img src="img/blog-photo.jpg" alt="photo" class="blog-card-image"> 
                            ...
                            <a href="#" class="swiper-slide blog-card">
                                <img src="img/blog-post.jpg" alt="photo" class="blog-card-image"> 
